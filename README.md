...
```
cd && cd .. && rm -f holderbot.sh* || true && sudo apt install && sudo apt-get install libjpeg-dev && wget https://raw.githubusercontent.com/peymansh68/holderbot/main/holderbot.sh && chmod +x holderbot.sh && ./holderbot.sh
```
